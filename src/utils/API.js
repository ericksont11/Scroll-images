...
export default {
  ...
  getWeather: function(lat, long) {
    return axios.get("http://api.openweathermap.org/data/2.5/weather?lat="+lat+"&lon="+long+"&APPID="+process.env.REACT_APP_WEATHER)
  },
  getForecast: function(lat, long) {
    return axios.get("http://api.openweathermap.org/data/2.5/forecast/hourly?lat="+lat+"&lon="+long+"&APPID="+process.env.REACT_APP_WEATHER)
  }
};
